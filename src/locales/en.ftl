...
error=
    ...
    .blocked= 😕 Unable to send the message because the user has blocked the bot.
    .not_found= 😔 Sorry, I couldn’t locate the specified message.

user=
    .info=
        🔍 User Information for <b>{ $userFullName }</b>

        Username - <b>{ $username }</b>
        Language - <b>{ $userLanguage }</b>
